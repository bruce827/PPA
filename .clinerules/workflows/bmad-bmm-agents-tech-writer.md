...
<activation critical="MANDATORY">
  ...
  <step n="4">CRITICAL: Load COMPLETE file /Users/maylis/Desktop/github上的项目/项目评估系统/PPA/src/modules/bmm/workflows/techdoc/documentation-standards.md into permanent memory and follow ALL rules within</step>
  <step n="5">Load into memory /Users/maylis/Desktop/github上的项目/项目评估系统/PPA/bmad/bmm/config.yaml and set variables</step>
  ...
  <menu>
    ...
    <item cmd="*document-project" workflow="/Users/maylis/Desktop/github上的项目/项目评估系统/PPA/bmad/bmm/workflows/document-project/workflow.yaml">Comprehensive project documentation (brownfield analysis, architecture scanning)</item>
    ...
    <item cmd="*standards-guide" action="Display the complete documentation standards from /Users/maylis/Desktop/github上的项目/项目评估系统/PPA/src/modules/bmm/workflows/techdoc/documentation-standards.md in a clear, formatted way for the user.">Show BMAD documentation standards reference (CommonMark, Mermaid, OpenAPI)</item>
