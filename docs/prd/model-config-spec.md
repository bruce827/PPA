...
- 模块梳理 (module_analysis)
- Web3D Step4 分析 (web3d_step4_analysis)
...
- `web3d_step4_analysis` 仅用于 `/web3d/new` Step4 的 AI 模块梳理与工作量映射
- 该分类模板会由后端自动追加 Step1-3 上下文、当前工作量模板全集、角色配置和图片元数据
...
// 011_expand_prompt_template_categories_for_web3d_step4.js
```
